...
class ArticlesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.backkbutton.setOnClickListener {
            finish()
        }
    ...
    blogAdapter = ArticleAdapter(this, emptyList(), object : ArticleAdapter.OnItemClickListener {
        ...
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@ArticlesActivity, "Error loading saved articles", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun deleteBlogPost(blogItem: BlogItemModel) {
        ...
        blogPostReference.removeValue()
            .addOnSuccessListener {
                ...
                Toast.makeText(this, "Failed to delete blog post: ${e.message}", Toast.LENGTH_SHORT).show() }
    }
